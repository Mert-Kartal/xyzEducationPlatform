-- CreateEnum
CREATE TYPE "OptionLabel" AS ENUM ('A', 'B', 'C', 'D', 'NONE');

-- CreateEnum
CREATE TYPE "Role" AS ENUM ('Student', 'Professor', 'Assistant', 'Admin');
...
-- AddForeignKey
ALTER TABLE "answers" ADD CONSTRAINT "answers_testId_fkey" FOREIGN KEY ("testId") REFERENCES "tests"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
